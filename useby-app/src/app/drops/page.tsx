...
import { StoreDropsWorkspace } from "../../components/store-drops/store-drops-workspace";

export default function StoreDropsPage() {
  return (
        ...
        <header className="flex flex-wrap items-center justify-between gap-4 border-b border-[#d2dbc9] pb-5">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span>
              ...
              <span className="block text-sm text-[#65715f]">Riverside Quarter drops</span>
            </span>
          </Link>
